                ...
                child: AnimatedContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("${index + 20}", style: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
              );
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              image: const DecorationImage(
                image: NetworkImage("https://images.unsplash.com/photo-1515377905703-c4788e51af15?q=80&w=1170&auto=format&fit=crop"),
                fit: BoxFit.cover,
                opacity: 0.5,
              ),
            ),
  ...
  void _showSubscriptionDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text("Unlock Advanced Mastery"),
        content: const Text("Become a Pro member to access professional buccal massage and deep tissue sculpting techniques."),
        actions: [
